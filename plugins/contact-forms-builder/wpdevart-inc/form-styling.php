...
/*
  ...
  There are multiple ways in which css  styles  are applied to our form , that are :
    ...
    4 . Every form created by WpDevArt Contact Forms plugin can have its own styling 
 
  NOTE: please note that custom styling for WpDevArt Contact Forms is stored in WordPress 
