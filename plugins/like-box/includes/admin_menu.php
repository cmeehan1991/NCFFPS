...
class like_box_admin_menu{
	...
	/*############################### Posts pages insert buttons function part ########################################*/
			...
			<div class="inside_information_div">
				...
				<tbody> 
                  ...
                  <tr>
                    ...
                    <tr>
						<td>
							Show/Hide latest posts <span class="pro_feature"> (pro)</span> <span title="Choose to show or hide the latest posts from Facebook." class="desription_class">?</span>
						</td>
						<td>
